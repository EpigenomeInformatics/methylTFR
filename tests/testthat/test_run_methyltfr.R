...
test_that("run_methyltfr",{
  ...
  # Test invalid inputs
  expect_error(run_methyltfr(sample_ann = "sample_ann.tsv", sample_dir = ".",
   filetype = "invalid"), "Please provide a valid file type")
  expect_error(run_methyltfr(sample_ann = "sample_ann.tsv", sample_dir = ".",
  filetype ="epp", sampleColName = NULL), "Please provide a valid sample column name")
  expect_error(run_methyltfr(sample_ann = "sample_ann.tsv", sample_dir = ".",
   filetype ="epp"), "Please load the annotation objects for given genome.")
